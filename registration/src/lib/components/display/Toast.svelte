...
<div class="absolute w-full bottom-0 mb-10 right-0 {show ? 'flex ' : 'hidden'} lg:hidden px-5">
	<div
		id="toast-success"
		class="flex items-center w-full p-4 rounded-lg shadow text-gray-400 bg-gray-800"
		role="alert"
	>
		<div
